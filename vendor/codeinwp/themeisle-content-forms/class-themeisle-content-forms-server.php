...
class RestServer extends \WP_Rest_Controller {
			...
			array(
				...
				'args'                => array(
					'form_type' => array(
						'type'        => 'string',
						'required'    => true,
						'description' => __( 'What type of form is submitted.', 'elementor-addon-widgets' ),
					),
					'nonce'     => array(
						'type'        => 'string',
						'required'    => true,
						'description' => __( 'The security key', 'elementor-addon-widgets' ),
					),
					'data'      => array(
						'type'        => 'json',
						'required'    => true,
						'description' => __( 'The form must have data', 'elementor-addon-widgets' ),
					),
					'form_id'   => array(
						'type'        => 'string',
						'required'    => true,
						'description' => __( 'The form identifier.', 'elementor-addon-widgets' ),
					),
					'post_id'   => array(
						'type'        => 'string',
						'required'    => true,
	...
	public function submit_form( $request ) {
		$return = array(
			'success' => false,
			'msg'     => esc_html__( 'Something went wrong', 'elementor-addon-widgets' )
		);
		...
		if ( empty( $data[ $form_id ] ) ) {
			$return['msg'] = esc_html__( 'Invalid Data ', 'elementor-addon-widgets' ) . $form_id;
			return $return;
		}
